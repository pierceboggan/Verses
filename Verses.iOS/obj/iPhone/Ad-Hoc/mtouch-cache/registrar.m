...
native_to_managed_trampoline_SQLite_MonoTouchAdmin_TablesViewController_Data_GetCell (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_8, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_Source_WillDisplay (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_79, 1));
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_79, 2));
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_Source_RowDeselected (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_80, 1));
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_Verses_iOS_PrayersViewController_ViewDidAppear (id this, SEL sel, bool p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Verses_iOS_PrayersViewController_GetSupportedInterfaceOrientations (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Verses_iOS_VersesViewController_GetSupportedInterfaceOrientations (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Verses_iOS_FlipCardController_ViewDidAppear (id this, SEL sel, bool p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_Dialog_DialogViewController_SizingSource_GetHeightForRow (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_111, 1));
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_Verses_iOS_MemorizationDialogViewController_ViewDidDisappear (id this, SEL sel, bool p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_BeginTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_129, 1));
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Dialog_GlassButton_EndTracking (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr (nsobj1, false, monotouch_get_parameter_type (method_130, 1));
		}
		arg_ptrs [1] = mobj1;
...
static MTClass __monotouch_classes [] = {
	...
	{"Verses.iOS.PrayerComposeDialog", "UIViewController", 1, 3, 0},
	{"Verses.iOS.PrayerComposeDialog+ContentTextDelegate", "NSObject", 1, 3, 0},
	{"Verses.iOS.VersesTableSource", "NSObject", 1, 6, 0},
	{"Verses.iOS.PrayersTableSource", "NSObject", 1, 6, 0},
	{"Verses.iOS.PrayerEditDialog", "UIViewController", 1, 2, 0},
	{"Verses.iOS.VerseEditDialog", "UIViewController", 1, 2, 0},
	{"Verses.iOS.VerseDetailDialog", "UIViewController", 1, 4, 0},
	{"Verses.iOS.VerseComposeDialog", "UIViewController", 1, 2, 0},
	{"Verses.iOS.VerseComposeDialog+CommentsTextDelegate", "NSObject", 1, 3, 0},
	{"Verses.iOS.PrayerDetailDialog", "UIViewController", 1, 4, 0},
	...
	{"Verses.iOS.VersesViewController", "UIViewController", 1, 4, 0},
	...
	{"Verses.iOS.FlipCardController", "UIViewController", 1, 3, 0},
	...
	{"Verses.iOS.MemorizationDialogViewController", "MonoTouch.Dialog.DialogViewController", 1, 4, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"viewDidAppear:","v@:B",0, &native_to_managed_trampoline_Verses_iOS_PrayersViewController_ViewDidAppear},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_Verses_iOS_PrayersViewController_ViewDidLoad},
	{"supportedInterfaceOrientations","i@:",0, &native_to_managed_trampoline_Verses_iOS_PrayersViewController_GetSupportedInterfaceOrientations},
	...
	{"supportedInterfaceOrientations","i@:",0, &native_to_managed_trampoline_Verses_iOS_VersesViewController_GetSupportedInterfaceOrientations},
	...
	{"viewDidAppear:","v@:B",0, &native_to_managed_trampoline_Verses_iOS_FlipCardController_ViewDidAppear},
	...
	{"viewDidDisappear:","v@:B",0, &native_to_managed_trampoline_Verses_iOS_MemorizationDialogViewController_ViewDidDisappear},
...
int __monotouch_map_count = 119;
static int __monotouch_class_count = 54;
